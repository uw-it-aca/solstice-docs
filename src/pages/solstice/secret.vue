    ...
    <template #content>
      ...
      <div class="mb-5 grid" style="--bs-columns: 8">
        <div>
          ...
          <div class="bg-purple3-100 small p-3 text-black">$purple3-100</div>
          <div class="bg-purple3-200 small p-3 text-black">$purple3-200</div>
          <div class="bg-purple3-300 small p-3 text-white">$purple3-300</div>
          <div class="bg-purple3-400 small p-3 text-white">$purple3-400</div>
          <div class="bg-purple3-500 small p-3 text-white">$purple3-500</div>
          <div class="bg-purple3-600 small p-3 text-white">$purple3-600</div>
          <div class="bg-purple3-700 small p-3 text-white">$purple3-700</div>
          <div class="bg-purple3-800 small p-3 text-white">$purple3-800</div>
          <div class="bg-purple3-900 small p-3 text-white">$purple3-900</div>
        </div>
        <div>
      ...
      <table class="table">
        <thead>
          <tr>
            <th scope="col" style="width: 90px">Color</th>
      ...
      <div class="mb-5 grid">
        <div class="g-col-6">
          ...
          <div class="input-group mb-3">
            ...
            <button
              id="button-addon2"
              class="btn btn-subdued-primary link-underline link-underline-opacity-0 border-secondary border"
              type="button"
            >
              Button
            </button>
      ...
      <div class="mb-5 grid">
        ...
        <div class="g-col-4">
          ...
          <BCard bg-variant="body-tertiary" class="mb-3 border-0"
            >body-tertiary</BCard
          >
          <BCard bg-variant="body-secondary" class="bg-opacity-50 mb-3 border-0"
        ...
        <div class="g-col-6">
          <BCard class="mb-3 border-0 shadow">
            ...
            <p>
              ...
              <BLink href="#" variant="primary"
                >distinctio ipsum (default)</BLink
              >
              doloribus animi? Quae ad sit quasi voluptate perferendis
              consequatur tempore fuga repudiandae.
            </p>
...
<script>
  ...
  import { BBadge, BButton, BCard, BLink } from "bootstrap-vue-next";
