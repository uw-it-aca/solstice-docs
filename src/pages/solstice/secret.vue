    ...
    <template #content>
      ...
      <div class="grid mb-5" style="--bs-columns: 8">
        <div>
          ...
          <div class="p-3 bg-purple3-100 text-black small">$purple3-100</div>
          <div class="p-3 bg-purple3-200 text-black small">$purple3-200</div>
          <div class="p-3 bg-purple3-300 text-white small">$purple3-300</div>
          <div class="p-3 bg-purple3-400 text-white small">$purple3-400</div>
          <div class="p-3 bg-purple3-500 text-white small">$purple3-500</div>
          <div class="p-3 bg-purple3-600 text-white small">$purple3-600</div>
          <div class="p-3 bg-purple3-700 text-white small">$purple3-700</div>
          <div class="p-3 bg-purple3-800 text-white small">$purple3-800</div>
          <div class="p-3 bg-purple3-900 text-white small">$purple3-900</div>
        </div>
        <div>
